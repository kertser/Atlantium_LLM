...
class Config:
    ...
    MAX_METADATA_SIZE: int = 30000000  # We have to keep it large, since 100-200 docs can take 15Gb space
    CHUNK_SIZE: int = 512  # Optimal for larger content. Smaller chunks are more selective, but harder to compare
